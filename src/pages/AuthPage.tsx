...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <SEO title="Sign in or create your account — RinVita" description="Access your RinVita health vault. Sign in or create a free account — your first 3 documents are free, forever." path="/auth" noindex />
