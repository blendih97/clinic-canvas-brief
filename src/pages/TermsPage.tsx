        ...
        <div style={{ maxWidth: 820, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              For any questions about these Terms, please contact <a href="mailto:info@rinvita.co.uk" style={{ color: marketingColors.gold, textDecoration: "underline" }}>info@rinvita.co.uk</a>.
            </p>
          </div>
          ...
          <p style={bodyStyle}>Questions about these Terms? Email <a href="mailto:info@rinvita.co.uk" style={{ color: marketingColors.gold }}>info@rinvita.co.uk</a>.</p>
